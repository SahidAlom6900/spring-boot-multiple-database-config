package com.te.two.db.customer.config;
...
public class CustomerConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.te.two.db.customer.entity").persistenceUnit("db1")
				.build();
	}
